...
#warning delete:
    ...
    NSLog(@"Frame: x:%f y:%f w:%f h%f", self.labelYear.frame.origin.x,self.labelYear.frame.origin.y,self.labelYear.frame.size.width,self.labelYear.frame.size.height);
