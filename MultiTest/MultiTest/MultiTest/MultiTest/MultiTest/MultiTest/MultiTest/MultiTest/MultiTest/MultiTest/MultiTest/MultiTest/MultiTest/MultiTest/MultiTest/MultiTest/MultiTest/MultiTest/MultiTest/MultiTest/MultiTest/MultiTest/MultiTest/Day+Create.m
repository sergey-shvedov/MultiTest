        ...
        if ([mathes count]) {
            ...
            for (NSInteger myId=0; myId<[mathes count]; myId++) {
                ...
                if (([((Day *)[mathes objectAtIndex:myId]).last180TripDays integerValue] + myId -usedTrips) < 90) {
                    NSLog(@"myID=%d last180TripDays(%@) value<90(%d) usedTrips(%d) - %d",myId,((Day *)[mathes objectAtIndex:myId]).last180TripDays,[((Day *)[mathes objectAtIndex:myId]).last180TripDays integerValue] + myId  - usedTrips, usedTrips, [mathes count]);
                        ...
                        for (int z=0; z<[mathes2 count]; z++) {
                            ...
                            if (![((Day *)[mathes2 objectAtIndex:z]).tripsByDay count]) {  //its not a trip day
                               ...
                               //NSLog(@"a trip day: %d",[((Day *)[mathes2 objectAtIndex:z]).last180TripDays integerValue] );
                                if ([((Day *)[mathes2 objectAtIndex:z]).last180TripDays integerValue]  > maxX) {
                                    z=1000;
                                    myIndex=1000;
                                }
                            }
